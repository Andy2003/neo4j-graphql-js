        ...
        const query = /* GraphQL */ `
            {
                posts(
                    where: {
                        likesAggregate: { node: { AND: [{ someFloat_SUM_EQUAL: 10 }, { someFloat_SUM_EQUAL: 11 }] } }
                    }
                ) {
                    content
                }
        ...
        const query = /* GraphQL */ `
            {
                posts(
                    where: {
                        likesAggregate: { node: { OR: [{ someFloat_SUM_EQUAL: 10 }, { someFloat_SUM_EQUAL: 11 }] } }
                    }
                ) {
                    content
                }
        ...
        const query = /* GraphQL */ `
            {
                posts(
                    where: {
                        likesAggregate: {
                            node: { OR: [{ NOT: { someFloat_SUM_EQUAL: 10 } }, { someFloat_SUM_EQUAL: 11 }] }
                        }
                    }
                ) {
                    content
